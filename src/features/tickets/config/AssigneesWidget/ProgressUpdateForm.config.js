...
export const ProgressUpdateFormConfig = {
  ...
  title: "Log Progress",
  api: "/WorkStream/LogProgress", // 👈 The API endpoint your backend auto-built
  ...
  actions: [
    {
      type: "submit",
      label: "Post Update",
      className: "w-full py-2.5 px-4 bg-gray-900 text-white rounded-lg text-sm font-medium hover:bg-gray-800 transition-colors shadow-sm"
    }
  ]
};