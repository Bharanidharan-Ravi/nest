...
//     customValidator: (value, formData, context) => {
//       const isAlreadyOn = context?.activeTicket?.IsCloseRequested;
//       if (value === true && !isAlreadyOn) {
...
//     customValidator: (value, formData, context) => {
//       const isAlreadyOn = context?.activeTicket?.PriorityRequest;
//       if (value === true && !isAlreadyOn) {
//         const cleanDesc = formData?.description
//           ?.replace(/<[^>]*>?/gm, "")
//           .trim();
//         if (!cleanDesc) {
//           return "Add description regarding Priority";
//         }
//       }
//       return true;
//     },
...
//     customValidator: (value, formData, context) => {
//       const isAlreadyOn = context?.activeTicket?.FuncResponse;
//       if (value === true && !isAlreadyOn) {
//         const cleanDesc = formData?.description
//           ?.replace(/<[^>]*>?/gm, "")
//           .trim();
...
export const ThreadFieldConfig = (ticketId) => [
  ...
  },
  {
    ...
    // visibleWhen: (formData, context) => {
    //   const isRequested = !!formData.requestClose;
