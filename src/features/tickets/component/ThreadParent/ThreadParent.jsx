...
const ThreadParent = ({ item }) => {
  ...
  return (
    // <div className="p-6 bg-white rounded-lg mx-auto mt-0">
      <div className="flex flex-col gap-4">
        ...
        {/* ONLY THIS HEADER STAYS FIXED */}
        <div className="sticky top-[-12px] z-50 bg-white py-3 border-b border-gray-100 -mx-6 px-6">
        ...
        {/* THIS PART WILL SCROLL NORMALLY */}
  ...
  //     <div className="sticky top-0 z-20 bg-white shadow-sm py-3 border-b border-gray-200">
  //       {/* Title and Labels */}
  //       <div className="flex flex-col md:flex-row gap-3 md:gap-6 items-start md:items-center">
  //         {/* Title */}
  //         <h3 className="text-2xl text-gray-800 font-semibold hover:text-ghBlue transition-all duration-300">
  //           {item.title}
  //         </h3>
