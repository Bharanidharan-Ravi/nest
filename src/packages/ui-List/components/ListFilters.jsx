...
export function ListFilters() {
    ...
    const buttonClasses = theme.filterButton || 
    ...
    return (
        <div className="flex gap-2 items-center" ref={wrapperRef}>
            {config.filters.map((filter) => {
                ...
                const activeOption = (filter.options && filter.options.find((opt) => opt.value === currentValue)) || 
                ...
                return (
                    <div key={filter.key} className="relative" ref={ref}>
                        <button
